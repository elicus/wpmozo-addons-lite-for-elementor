...
// Start Blog Categories Functions.
		/**
		...
		public function wpmozo_register_post_types() {
			...
			if ( ! $this->wpmozo_is_team_disabled() ) {
				...
				$team_args = array(
					...
					'hierarchical'      => false,
					'menu_position'     => 20,
					'menu_icon'         => 'data:image/svg+xml;base64,' . base64_encode( file_get_contents( WPMOZO_ADDONS_LITE_FOR_ELEMENTOR_DIR_PATH . 'admin/assets/images/team-member-icon.svg' ) ),
					'show_ui'           => true,
					'show_in_menu'      => true,
			...
			if ( ! $this->wpmozo_is_testimonial_disabled() ) {
				...
				$testimonial_args = array(
					...
					'hierarchical'      => false,
					'menu_position'     => 20,
					'menu_icon'         => 'data:image/svg+xml;base64,' . base64_encode( file_get_contents( WPMOZO_ADDONS_LITE_FOR_ELEMENTOR_DIR_PATH . 'admin/assets/images/testimonial-icon.svg' ) ),
					'show_ui'           => true,
					'show_in_menu'      => true,
					'show_in_nav_menus' => true,
					'has_archive'       => true,
