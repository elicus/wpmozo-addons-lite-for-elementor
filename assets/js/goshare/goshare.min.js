...
$(document).ready(function(){$($this).mouseup(function(event){var selection=getSelected().toString().trim();if(selection===""){HideGoShar();return}
var posX=event.pageX+10;var posY=event.pageY+10;$("#social").css({left:posX,top:posY,opacity:1})})});return this};$(".wpmozo-select-actions-yes").goshare()}(jQuery))