...
if ( $query->have_posts() ) 
{
    foreach ( $query->posts as $index => $post ) {        
        ...
        <div <?php $this->print_render_attribute_string( 'swiper_layout_item' . $index ) ; ?>>            
            <div id="wpmozo_ae_team_member_<?php echo esc_attr( get_the_ID() ); ?>" class="wpmozo_ae_team_member_card <?php echo esc_attr( 'yes' === $enable_member_link ? 'wpmozo_team_link' : '' ); ?>"
                data-link="<?php echo esc_attr( get_the_permalink() ); ?>" data-link_target="<?php echo esc_attr( $member_link_target ); ?>">
                ...
                <div class="wpmozo_team_content_wrapper">
                    ...
                    <div class="wpmozo_ae_team_member_designation">
                        <<?php echo esc_html( $designation_heading_level ); ?>  class="wpmozo_ae_team_member_designation_heading"><?php echo esc_html( get_post_meta( get_the_ID(), 'wpmozo_ae_team_member_designation', true ) ); ?></<?php echo esc_html( $designation_heading_level ); ?>>
                    </div>
                    <?php endif; ?>
                            ...
                            foreach( $skills_arr as $key => $value ) {
                                if( !empty( $skills_arr[ $key ] ) ) {
                                    ...
                                    <div class="wpmozo_skill_bar_wrapper_inner">
                                        <div class="wpmozo_skill_name"><?php echo wp_kses_post( $skills_arr[ $key ] ); ?></div>
