    ...
    foreach ( $query->posts as $index => $post ) {        
        ...
        <div <?php echo $this->get_render_attribute_string( 'swiper_layout_item' . $index ) ; ?>>  
            <div class="wpmozo_ae_team_member_slide" role="group" >
                <div id="wpmozo_ae_team_member_<?php echo get_the_ID(); ?>" class="wpmozo_ae_team_member_card <?php echo 'yes' === $enable_member_link ? 'wpmozo_team_link' : ''; ?>" data-link="<?php echo get_the_permalink(); ?>" data-link_target="<?php echo $member_link_target; ?>">
                    ...
                    <div class="wpmozo_team_content_wrapper">
                        ...
                        <div class="wpmozo_ae_team_member_designation">
                            <<?php echo esc_html( $designation_heading_level ); ?> class="wpmozo_ae_team_member_designation_heading"><?php echo get_post_meta( get_the_ID(), 'wpmozo_ae_team_member_designation', true ); ?></<?php echo esc_html( $designation_heading_level ); ?> class="wpmozo_ae_team_member_designation_heading">
                        </div>
                        <?php endif; ?>
