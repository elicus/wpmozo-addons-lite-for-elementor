...
$this->start_controls_section(
	...
	$this->add_control(
		'link_target',
		array(
			'label'       => esc_html__( 'Social Icon Link Target', 'wpmozo-addons-lite-for-elementor' ),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				...
				array(
					...
					'default'     => '#cccccc',
					'selectors'   => array(
						'{{WRAPPER}} .wpmozo_ae_swiper_pagination .swiper-pagination-bullet' => 'background: {{VALUE}};',
						'{{WRAPPER}} .wpmozo_ae_swiper_pagination .swiper-pagination-bullets-dynamic' => 'width: 100% !important;',
					),
					'condition'   => array( 'show_control_dot' => 'yes' ),
				)
			);
			...
			$this->add_control(
				'team_width',
				array(
					'label'      => esc_html__( 'Team Width', 'wpmozo-addons-lite-for-elementor' ),
					'type'       => Controls_Manager::SLIDER,
