...
$this->start_controls_section(
	...
	$this->add_control(
		...
		array(
			...
			'label_block' => true,
			'multiple'    => true,
			'options'     => wpmozo_addons_lite_for_elementor()::$public_instance->wpmozo_get_blog_posts_categories(),
		)
	);
	$this->add_control(
		'category_order',
	...
	$this->add_control(
		...
		array(
			...
			'default' => esc_html__( 'The categories you requested could not be found. Try changing your widget settings or create some new posts.', 'wpmozo-addons-lite-for-elementor' ),
		)
	);
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_blog_category_name' => 'color: {{VALUE}};',
			),
		)
	);
	...
	$this->add_responsive_control(
		...
		array(
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_blog_category_name:hover' => 'color: {{VALUE}};',
			),
		)
	);
	$this->add_group_control(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_blog_category_count' => 'color: {{VALUE}};',
			),
		)
	);
	$this->add_group_control(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_blog_category_count' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};overflow:hidden;',
			),
		)
	);
	$this->end_controls_tab();
	...
	$this->add_responsive_control(
		...
		array(
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_blog_category_count:hover' => 'color: {{VALUE}};',
			),
		)
	);
	$this->add_group_control(
	...
	$this->add_group_control(
		Group_Control_Text_Shadow::get_type(),
		array(
			'name'      => 'post_count_text_shadow_hover',
			'label'     => esc_html__( 'Text Shadow', 'wpmozo-addons-lite-for-elementor' ),
			'selector'  => '{{WRAPPER}} .wpmozo_blog_category_count:hover',
		)
	);
	...
	$this->add_responsive_control(
		...
		array(
			...
			'size_units'  => array( 'px', 'em', '%' ),
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_blog_category_count:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
		)
	);
	$this->end_controls_tab();
	...
	$this->start_controls_tabs(
		'post_count_margin_padding_tabs'
	);
	$this->start_controls_tab(
		'post_count_padding_tab',
		array(
	...
	$this->add_control(
		'thumbnail_fit',
		array(
			'label'       => __( 'Thumbnail Fit', 'wpmozo-addons-lite-for-elementor' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
			...
			'default'     => '',
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_category_image_wrapper img' => 'object-fit: {{VALUE}};',
			),
		)
	);
	$this->add_responsive_control(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'size_units'  => array( 'px', 'em', '%' ),
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_category_image_wrapper img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
		)
	);
	$this->end_controls_tab();
	...
	$this->add_responsive_control(
		...
		array(
			...
			'size_units'  => array( 'px', 'em', '%' ),
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_category_image_wrapper img:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
		)
	);
	$this->end_controls_tab();
	...
	$this->add_responsive_control(
		...
		array(
			...
			'size_units'  => array( 'px', 'em', '%' ),
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_blog_categories_wrapper .wpmozo_blog_category_item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
		)
	);
	$this->end_controls_tab();
	...
	$this->add_group_control(
		...
		array(
			...
			'selector'       => '{{WRAPPER}} .wpmozo_blog_categories_wrapper .wpmozo_blog_category_item:hover',
		)
	);
	$this->add_group_control(
		Group_Control_Border::get_type(),
	...
	$this->add_responsive_control(
		...
		array(
			...
			'size_units'  => array( 'px', 'em', '%' ),
			'selectors'   => array(
				'{{WRAPPER}} .wpmozo_blog_categories_wrapper .wpmozo_blog_category_item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			),
		)
	);
	$this->end_controls_tab();
