...
$this->end_controls_section();
	...
	$this->add_responsive_control(
		'posts_per_slide',
		array(
			'label'     => esc_html__( 'Number of Posts Per Slide', 'wpmozo-addons-lite-for-elementor' ),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 1,
			'separator' => 'before',
			'max'       => 15,
	...
	$this->add_control(
		...
		array(
			...
			'selectors'            => array(
				...
				'{{WRAPPER}}.wpmozo_ae_equal_height .wpmozo_wrapper .wpmozo_advanced_blog_slider_post'  => 'height:100%;',
				'{{WRAPPER}}.wpmozo_ae_equal_height .wpmozo_wrapper .wpmozo_readmore_button_wrapper'    => 'display: flex; align-items: flex-end; flex-grow: 1;',
			),
		)
	);
	$this->add_control(
	...
	$this->add_control(
		...
		array(
			...
			'selectors'            => array( '{{WRAPPER}} .swiper-wrapper' => 'transition-timing-function: {{VALUE}} !important; align-items:stretch;' ),
		)
	);
	$this->add_control(
