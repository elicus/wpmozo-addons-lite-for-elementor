    ...
    var e = elementorModules.frontend.handlers.Base.extend( {
        ...
        change: function () {
            jQuery( document ).ready( function ( n ) {
                ...
                if ( jQuery( "body" ).find( ".elementor-widget-wpmozo_ae_facebook_embedded_video" ).length > 0 ) {
                    jQuery( "body" ).find( ".elementor-widget-wpmozo_ae_facebook_embedded_video" ).each( function () {
