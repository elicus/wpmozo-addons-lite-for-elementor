<?php
/**
 * Registers all the controls for the Justified Gallery widget in WPMozo, enabling customization of gallery settings in Elementor.
 *
...
$this->start_controls_section(
	...
	$this->start_controls_tabs( 'category_normal_and_active_tabs' );
		...
		$this->add_responsive_control(
			'category_normal_color_hover',
			array(
				'label'       => esc_html__( 'Hover Color', 'wpmozo-addons-for-elementor' ),
				'label_block' => false,
				'type'        => Controls_Manager::COLOR,
				'selectors'   => array(
					'{{WRAPPER}} ul.wpmozo-justified-gallery-filter li.wpmozo-filter-item:hover a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->start_controls_tab(
			...
			$this->add_responsive_control(
				'category_active_color_hover',
				array(
					'label'       => esc_html__( 'Hover Color', 'wpmozo-addons-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'{{WRAPPER}} ul.wpmozo-justified-gallery-filter li.wpmozo-filter-item.active:hover a' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				'search_icon_padding',
				array(
					'label'      => esc_html__( 'Search Icon Padding', 'wpmozo-addons-for-elementor' ),
					...
					'selectors'  => array(
						'{{WRAPPER}} figcaption.wpmozo-justified-gallery-item-overlay span.wpmozo-icon-wrap svg' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'   => array(
						'{{WRAPPER}} figcaption.wpmozo-justified-gallery-item-overlay span.wpmozo-icon-wrap svg' => 'height: {{SIZE}}{{UNIT}};width: {{SIZE}}{{UNIT}};',
					),
					'render_type' => 'template',
					'condition'   => array(
						'enable_overlay' => 'yes',
			...
			$this->add_responsive_control(
				'overlay_text_title_color_hover',
				array(
					'label'       => esc_html__( 'Hover Color', 'wpmozo-addons-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'{{WRAPPER}} figcaption.wpmozo-justified-gallery-item-overlay :is(h1, h2, h3, h4, h5, h6):hover' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				'overlay_text_caption_color_hover',
				array(
					'label'       => esc_html__( 'Color', 'wpmozo-addons-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'{{WRAPPER}} figcaption.wpmozo-justified-gallery-item-overlay .wpmozo-item-caption:hover' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				'lightbox_text_title_color_hover',
				array(
					'label'       => esc_html__( 'Hover Color', 'wpmozo-addons-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'{{WRAPPER}}.mfp-wrap .mfp-title .wpmozo-item-title:hover' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
			...
			$this->add_responsive_control(
				'lightbox_text_caption_color_hover',
				array(
					'label'       => esc_html__( 'Hover Color', 'wpmozo-addons-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
						'{{WRAPPER}}.mfp-wrap .mfp-title .wpmozo-item-caption:hover' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control(
			...
			$this->add_control(
				'custom_style_for_load_more_btn',
				array(
			...
			$this->start_controls_tabs(
				'load_more_btn_normal_and_hover_tabs',
				array(
					'condition' => array(
			...
			// Hover Tab.
			$this->start_controls_tab(
				'load_more_btn_hover_tab',
				array(
					'label' => esc_html__( 'Normal', 'wpmozo-addons-for-elementor' ),
				)
			);
			$this->add_responsive_control(
				'load_more_btn_size_hover',
				array(
					'type'       => Controls_Manager::SLIDER,
					'label'      => esc_html__( 'Load More Button Text Size', 'wpmozo-addons-for-elementor' ),
					'size_units' => array( 'px' ),
					...
					'selectors'  => array( '{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'font-size: {{SIZE}}{{UNIT}};' ),
				)
			);
			$this->add_responsive_control(
				...
				array(
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'color: {{VALUE}};',
					),
					'condition' => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
			...
			$this->add_group_control(
				Group_Control_Background::get_type(),
				array(
					'name'      => 'load_more_btn_text_size_hover',
					'label'     => esc_html__( 'Background', 'wpmozo-addons-for-elementor' ),
					'types'     => array( 'classic', 'gradient' ),
					'selector'  => '{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover',
					'condition' => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
				)
			...
			$this->add_responsive_control(
				'load_more_btn_border_width_hover',
				array(
					'label'      => esc_html__( 'Load More Button Border Width', 'wpmozo-addons-for-elementor' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => array( 'px', 'em', '%' ),
					'selectors'  => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition'  => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
			...
			$this->add_responsive_control(
				'load_more_btn_border_radius_hover',
				array(
					'label'      => esc_html__( 'Load More Button Border Radius', 'wpmozo-addons-for-elementor' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => array( 'px', 'em', '%' ),
					'selectors'  => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition'  => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
			...
			$this->add_responsive_control(
				'load_more_btn_border_color_hover',
				array(
					'label'     => esc_html__( 'Load More Button Border Color', 'wpmozo-addons-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'border-color: {{VALUE}};',
					),
					'condition' => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
			...
			$this->add_responsive_control(
				'load_more_btn_icon_color_hover',
				array(
					'label'     => esc_html__( 'Load More Button Icon Color', 'wpmozo-addons-for-elementor' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .wpmozo-products-accordion-wrap .wpmozo-woo-product__add_to_cart .load_more_btn:hover svg path' => 'fill: {{VALUE}};',
					),
					'condition' => array(
						'custom_style_for_load_more_btn' => 'yes',
						'show_load_more_btn_icon'        => 'yes',
			...
			$this->add_responsive_control(
				'load_more_btn_margin_hover',
				array(
					'label'      => esc_html__( 'Load More Button Margin', 'wpmozo-addons-for-elementor' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => array( 'px', 'em', '%' ),
					'selectors'  => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition'  => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
			...
			$this->add_responsive_control(
				'load_more_btn_padding_hover',
				array(
					'label'      => esc_html__( 'Load More Button Padding', 'wpmozo-addons-for-elementor' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => array( 'px', 'em', '%' ),
					'selectors'  => array(
						'{{WRAPPER}} a.wpmozo-justified-gallery-load-more:hover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition'  => array(
						'custom_style_for_load_more_btn' => 'yes',
					),
