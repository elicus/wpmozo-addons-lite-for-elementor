...
$this->start_controls_section(
    ...
    $this->add_responsive_control( 
     ...
     $this->add_responsive_control( 
		'row_height',
		array( 
			'label'          => esc_html__( 'Row Height', 'wpmozo-addons-lite-for-elementor' ),
			'type'           => Controls_Manager::SLIDER,
			'range'          => array( 
				'px' => array( 
					'min'  => 50,
    ...
    $this->add_responsive_control(
        'lastrow_align',
        array(
            'label'             => esc_html__('Last Row Align', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'justify',
            'options'           => array(
                'justify' 	=> esc_html__( 'Justify', 'wpmozo-addons-lite-for-elementor' ),
                'center' 	=> esc_html__( 'Center', 'wpmozo-addons-lite-for-elementor' ),
                'right' 	=> esc_html__( 'Right', 'wpmozo-addons-lite-for-elementor' ),
                'nojustify' => esc_html__( 'No Justify', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type' => 'template'    
        )
    );
    $this->add_responsive_control(
        'click_trigger',
        array(
            'label'             => esc_html__('Click Trigger', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'off',
            'options'           => array(
                'off'		  => esc_html__( 'None', 'wpmozo-addons-lite-for-elementor' ),
                'lightbox'	  => esc_html__( 'Lightbox', 'wpmozo-addons-lite-for-elementor' ),
                'link' 		  => esc_html__( 'Custom Link', 'wpmozo-addons-lite-for-elementor' ),
                'zoom_n_link' => esc_html__( 'Both', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type' => 'template'    
        )
    );
...
$this->start_controls_section(
    ...
    $this->add_control(
        ...
        array(
            'label'         => esc_html__('Enable Filterable Gallery', 'wpmozo-addons-lite-for-elementor'),
    ...
    $this->add_control(
        'show_all_filter',
        array(
            'label'         => esc_html__('Show All Images filter', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::SWITCHER,
            'label_on'      => esc_html__('Yes', 'wpmozo-addons-lite-for-elementor'),
            'label_off'     => esc_html__('No', 'wpmozo-addons-lite-for-elementor'),
            'return_value'  => 'yes',
    ...
    $this->add_control(
        'all_images_text',
        array(
            'label'         => esc_html__('All Images Text', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::TEXT,
            'label_block'   => false,
            'default'       => esc_html__( 'All', 'wpmozo-addons-lite-for-elementor' ),
            'condition'     => array(
                'enable_filterable_gallery' => 'yes',
                'show_all_filter'           => 'yes'
            )
    ...
    $this->add_responsive_control(
        'terms_orderby',
        array(
            'label'             => esc_html__('Filterable Category Order By', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'none',
            'options'           => array(
                'none'       => esc_html__( 'None', 'wpmozo-addons-lite-for-elementor' ),
                'term_order' => esc_html__( 'Term Order', 'wpmozo-addons-lite-for-elementor' ),
                'date'       => esc_html__( 'Date', 'wpmozo-addons-lite-for-elementor' ),
                'name'       => esc_html__( 'Name/Title', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type' => 'template' ,
            'condition'         => array(
                'enable_filterable_gallery' => 'yes'
    ...
    $this->add_responsive_control(
        'terms_order',
        array(
            'label'             => esc_html__('Filterable Category Order', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'DESC',
            'options'           => array(
    ...
    $this->add_responsive_control(
        'title_area',
        array(
            'label'             => esc_html__('Show Title in', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'lightbox',
            'options'           => array(
                'lightbox'	=> esc_html__( 'Lightbox', 'wpmozo-addons-lite-for-elementor' ),
                'overlay' 	=> esc_html__( 'Overlay', 'wpmozo-addons-lite-for-elementor' ),
                'both'		=> esc_html__( 'Both', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type' => 'template' ,
            'condition'         => array(
                'show_title' => 'yes',
...
$this->start_controls_section(
    ...
    $this->add_control(
        'enable_navigation',
        array(
            'label'         => esc_html__('Enable Navigation', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::SWITCHER,
            'label_on'      => esc_html__('Yes', 'wpmozo-addons-lite-for-elementor'),
            'label_off'     => esc_html__('No', 'wpmozo-addons-lite-for-elementor'),
            'return_value'  => 'yes',
    ...
    $this->add_responsive_control(
        ...
        array(
            'label'             => esc_html__('Title & Caption Style', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'image_overlay',
            'options'           => array(
                'image_overlay'	=> esc_html__( 'Image Overlay', 'wpmozo-addons-lite-for-elementor' ),
				'below_image' 	=> esc_html__( 'Below Image', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type'       => 'template' ,
            'condition'         => array(
                'click_trigger' => array('lightbox', 'zoom_n_link'),
...
$this->start_controls_section(
    'pagination_sec',
    array(
        'label' => esc_html__('Pagination', 'wpmozo-addons-lite-for-elementor'),
        'condition'         => array(
            'click_trigger' => array('lightbox', 'zoom_n_link'),
        )  
    )
    ...
    $this->add_control(
        'enable_load_more',
        array(
            'label'         => esc_html__('Enable Pagination', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::SWITCHER,
            'label_on'      => esc_html__('Yes', 'wpmozo-addons-lite-for-elementor'),
            'label_off'     => esc_html__('No', 'wpmozo-addons-lite-for-elementor'),
            'return_value'  => 'yes',
    ...
    $this->add_control(
        'images_per_page',
        array(
            'label'         => esc_html__('Images per Page', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::TEXT,
    ...
    $this->add_responsive_control(
        'pagination_type',
        array(
            'label'             => esc_html__('Pagination Type', 'wpmozo-addons-lite-for-elementor'),
            'type'              => Controls_Manager::SELECT,
            'default'           => 'load_more',
            'options'           => array(
                'number'	=> esc_html__( 'Number Pagination', 'wpmozo-addons-lite-for-elementor' ),
				'load_more' => esc_html__( 'Load More Button', 'wpmozo-addons-lite-for-elementor' ),
            ),
            'render_type'       => 'template' ,
            'condition'         => array(
                'enable_load_more'  => 'yes'
    ...
    $this->add_control(
        'load_more_text',
        array(
            'label'         => esc_html__('Load More Text', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::TEXT,
            'dynamic'       => array( 'active' => true ),
            'label_block'   => false,
            'default'       => esc_html__( 'Load More', 'wpmozo-addons-lite-for-elementor' ),
            'condition'     => array(
                'enable_load_more'  => 'yes',
    ...
    $this->add_control(
        'show_prev_next',
        array(
            'label'         => esc_html__('Show Previous Next Links', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::SWITCHER,
            'label_on'      => esc_html__('Yes', 'wpmozo-addons-lite-for-elementor'),
            'label_off'     => esc_html__('No', 'wpmozo-addons-lite-for-elementor'),
            'return_value'  => 'yes',
    ...
    $this->add_control(
        'next_text',
        array(
            'label'         => esc_html__('Next Link Text', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::TEXT,
            'dynamic'       => array( 'active' => true ),
            'label_block'   => false,
            'default'       => esc_html__('Next','wpmozo-addons-lite-for-elementor'),
            'condition'     => array(
                'enable_load_more' => 'yes',
                'show_prev_next'   => 'yes',
                'pagination_type'  => 'number',
    ...
    $this->add_control(
        'prev_text',
        array(
            'label'         => esc_html__('Prev Link Text', 'wpmozo-addons-lite-for-elementor'),
            'type'          => Controls_Manager::TEXT,
            'dynamic'       => array( 'active' => true ),
            'label_block'   => false,
            'default'       => esc_html__('Prev','wpmozo-addons-lite-for-elementor'),
            'condition'     => array(
                'enable_load_more' => 'yes',
                'show_prev_next'   => 'yes',
                'pagination_type'  => 'number',
...
$this->start_controls_section(
    ...
    $this->start_controls_tabs( 'category_normal_and_active_tabs');
        ...
        $this->start_controls_tab( 'category_active_tab',
            array( 
                'label' => esc_html__( 'Active', 'wpmozo-addons-lite-for-elementor' ),
            )
        );
            $this->add_responsive_control( 
...
$this->start_controls_section(
    ...
    $this->add_responsive_control(
        'overlay_icon_size',
        array(
            'label'     => esc_html__('Overlay Icon Size', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::SLIDER,
            'default'   => array(
                'size' => 32,
                'unit' => 'px',
    ...
    $this->add_responsive_control(
        'zoom_icon_size',
        array(
            'label'     => esc_html__('Zoom Icon Size', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::SLIDER,
            'default'   => array(
                'size' => 16,
                'unit' => 'px',
    ...
    $this->add_control(
        'zoom_icon_bg',
        array(
            'label'     => esc_html__('Zoom Icon Background Color', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
    ...
    $this->add_control(
        'zoom_icon_color',
        array(
            'label'     => esc_html__('Zoom Icon Color', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
    ...
    $this->add_responsive_control(
        'link_icon_size',
        array(
            'label'     => esc_html__('Link Icon Size', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::SLIDER,
            'default'   => array(
                'size' => 16,
                'unit' => 'px',
    ...
    $this->add_control(
        'link_icon_bg',
        array(
            'label'     => esc_html__('Link Icon Background Color', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
    ...
    $this->add_control(
        'link_icon_color',
        array(
            'label'     => esc_html__('Link Icon Color', 'wpmozo-addons-lite-for-elementor'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
...
$this->start_controls_section(
    ...
    array(
        'label' => esc_html__('Overlay Text', 'wpmozo-addons-lite-for-elementor'),
        'tab'   => Controls_Manager::TAB_STYLE,
    )
);
...
$this->start_controls_section(
    ...
    array(
        'label' => esc_html__('Lightbox Text', 'wpmozo-addons-lite-for-elementor'),
        'tab'   => Controls_Manager::TAB_STYLE,
    )
);
...
$this->start_controls_section( 
	...
	array( 
		'label' => esc_html__( 'Load More Button', 'wpmozo-addons-lite-for-elementor' ),
		'tab'   => Controls_Manager::TAB_STYLE,
        'condition' => array(
            'pagination_type' => 'load_more'
        )
    ...
    $this->add_control( 'custom_style_for_load_more_btn',
        array( 
            'label'        => esc_html__( 'Use Custom Style For Load More Button', 'wpmozo-addons-lite-for-elementor' ),
            'type'         => Controls_Manager::SWITCHER,
            'label_off'    => esc_html__( 'NO', 'wpmozo-addons-lite-for-elementor' ),
            'label_on'     => esc_html__( 'YES', 'wpmozo-addons-lite-for-elementor' ),
            'return_value' => 'yes',
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'type'       => Controls_Manager::SLIDER,
            'label'      => esc_html__( 'Load More Button Text Size', 'wpmozo-addons-lite-for-elementor' ),
            'size_units' => array( 'px' ),
            'range'      => array( 
                'px' => array( 
                    'min' => 1,
    ...
    $this->add_responsive_control( 
        'load_more_btn_color',
        array( 
            'label'     => esc_html__( 'Load More Button Text Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'      => esc_html__( 'Load More Button Border Width', 'wpmozo-addons-lite-for-elementor' ),
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'      => esc_html__( 'Load More Button Border Radius', 'wpmozo-addons-lite-for-elementor' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', 'em', '%' ),
            'selectors'  => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Load More Button Border Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( 
    ...
    $this->add_control( 'show_load_more_btn_icon',
        array( 
            'label'        => esc_html__( 'Show Load More Button Icon', 'wpmozo-addons-lite-for-elementor' ),
            'type'         => Controls_Manager::SWITCHER,
            'label_off'    => esc_html__( 'NO', 'wpmozo-addons-lite-for-elementor' ),
            'label_on'     => esc_html__( 'YES', 'wpmozo-addons-lite-for-elementor' ),
            'return_value' => 'yes',
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Load More Button Icon Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'      => esc_html__( 'Load More Button Margin', 'wpmozo-addons-lite-for-elementor' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', 'em', '%' ),
            'selectors'  => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'      => esc_html__( 'Load More Button Padding', 'wpmozo-addons-lite-for-elementor' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', 'em', '%' ),
            'selectors'  => array( 
...
$this->start_controls_section( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Pagination Link Background Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => 'transparent',
            'selectors' => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Pagination Link Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#000',
            'selectors' => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Active Pagination Link Background Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#000',
            'selectors' => array( 
    ...
    $this->add_responsive_control( 
        ...
        array( 
            'label'     => esc_html__( 'Active Pagination Link Color', 'wpmozo-addons-lite-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#ffffff',
            'selectors' => array( 
