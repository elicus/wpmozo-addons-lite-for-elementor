    ...
    $this->add_responsive_control(
        ...
        array(
            ...
            'options'           => array(
                ...
                'link' 		  => esc_html__( 'Custom Link', 'wpmozo-addons-for-elementor' ),
                'zoom_n_link' => esc_html__( 'Both', 'wpmozo-addons-for-elementor' ),
            ),
            'render_type' => 'template'    
        )
    );
...
$this->start_controls_section(
    ...
    $this->add_responsive_control(
        ...
        array(
            ...
            'options'           => array(
                'lightbox'	=> esc_html__( 'Lightbox', 'wpmozo-addons-for-elementor' ),
                'overlay' 	=> esc_html__( 'Overlay', 'wpmozo-addons-for-elementor' ),
