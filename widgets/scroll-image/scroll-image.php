...
if ( !class_exists( 'WPMOZO_AE_Scroll_Image' ) ) {
	class WPMOZO_AE_Scroll_Image extends Widget_Base {
		...
		public function get_keywords() {
			return array( 'wpmz image scroll','wpmozo image scroll','wpmz scroll image','wpmozo scroll image' );
		}
		...
		protected function register_controls() {
			...
			require plugin_dir_path( dirname( __FILE__ ) ) . 'scroll-image/assets/controls/controls.php';
		}
