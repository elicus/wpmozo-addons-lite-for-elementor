...
$this->add_control(
	...
	array(
		...
		'default'     => esc_html__( 'My Bar Chart', 'wpmozo-addons-lite-for-elementor' ),
		'placeholder' => esc_html__( 'My Bar Chart', 'wpmozo-addons-lite-for-elementor' ),
		'label_block' => true,
	)
);
...
$repeater->add_control(
	...
	array(
		'label' => esc_html__( 'Bar Background Color', 'wpmozo-addons-lite-for-elementor' ),
