...
if ( ! class_exists( 'WPMOZO_AE_Advanced_Button' ) ) {
	class WPMOZO_AE_Advanced_Button extends Widget_Base {
		...
		protected function register_controls() {
			...
			require_once plugin_dir_path( __DIR__ ) . 'advanced-button/assets/controls/controls.php';
		}
		...
		protected function render() {
			...
			if ( $settings['buttons'] ) {
				foreach ( $settings['buttons'] as $index => $item ) {
					...
					?>
					<div class="wpmozo_button_item wpmozo_button_item_<?php echo esc_html( $index ); ?> elementor-repeater-item-<?php echo esc_html( $item['_id'] ) . ' ' . esc_html( $vertical_or_horizonal_fill_class ) . ' ' . esc_html( $icon_position ) . ' ' . esc_html( $icon_sizing ); ?>">
						<div class="wpmozo_button_wrapper wpmozo_button_<?php echo esc_html( $button_type ); ?>">
							<a class="<?php echo esc_html( $button_classes ); ?>" href="<?php echo esc_url( $button_link ); ?>" target="<?php echo esc_html( $item['url_new_window'] ); ?>" >
								<span class="wpmozo_primary_text_with_icon">
									<span class="wpmozo_button_text <?php echo esc_html( $custom_button_icon_class ); ?>"><?php echo esc_html( $button_text ); ?></span>
									<?php
									if ( '' !== $item['button_icon'] ) {
