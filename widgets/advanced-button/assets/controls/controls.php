                ...
                array( 
                    ...
                    'fields_options' => array( 
						...
						'font_size' => array( 
                            ...
                            'selectors' => array( '{{WRAPPER}} .wpmozo_primary_text_with_icon svg.wpmozo_ae_button_icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .wpmozo_primary_text_with_icon .wpmozo_button_text' => 'font-size:{{SIZE}}{{UNIT}};')
						 ),
					 ),
