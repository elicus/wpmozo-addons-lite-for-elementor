...
$this->start_controls_section( 'header_content',
        array(
            'label' => esc_html__( 'Header', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_CONTENT,
        )
    );

    $this->add_control( 'table_title_text',
        array(
            'label'       => esc_html__( 'Title', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::TEXT,
            'default'     => __('WPMozo Pricing','wpmozo-addons-for-elementor-lite'),
            'dynamic'     => array( 'active' => true ),
            'placeholder' => esc_html__( 'Enter Title', 'wpmozo-addons-for-elementor-lite' )
        )
    );

    $this->add_control( 'table_subtitle_text',
        array(
            'label'       => esc_html__( 'Subtitle', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::TEXT,
            'default'     => __('Ultimate plan','wpmozo-addons-for-elementor-lite'),
            'dynamic'     => array( 'active' => true ),
            'placeholder' => esc_html__( 'Enter Subtitle', 'wpmozo-addons-for-elementor-lite' ),
        )
    );

    $this->add_control( 'header_graphics',
        array(
            'label'    => esc_html( 'Header Graphics', 'wpmozo-addons-for-elementor-lite' ),
            'type'     => Controls_Manager::CHOOSE,
            'options'  => array(
                'icon' => array(
                    'title' => esc_html__( 'Icon', 'wpmozo-addons-for-elementor-lite' ),
                    'icon'  => 'eicon-icon-box',
                ),
                'image' => array(
                    'title' => esc_html__( 'Image', 'wpmozo-addons-for-elementor-lite' ),
                    'icon'  => 'eicon-image',
                ),
            ),
            'default'   => 'icon',
...
//Pricing settings
$this->start_controls_section( 'pricing_content',
        array(
            'label' => esc_html__( 'Table Pricing', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_CONTENT,
        )
    );
    ...
    $this->add_control( 'currency_symbol',
        array(
            'label'   => esc_html__( 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::SELECT,
            'options' => array(
                ''            => esc_html__( 'None', 'elementor-pro' ),
                'dollar'      => '&#36;' . _x( ' Dollar', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'euro'        => '&#128;' . _x( ' Euro', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'baht'        => '&#3647; ' . _x( 'Baht', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'franc'       => '&#8355; ' . _x( 'Franc', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'guilder'     => '&fnof; ' . _x( 'Guilder', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'krona'       => 'kr ' . _x( 'Krona', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'lira'        => '&#8356; ' . _x( 'Lira', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'peseta'      => '&#8359 ' . _x( 'Peseta', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'peso'        => '&#8369; ' . _x( 'Peso', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'pound'       => '&#163; ' . _x( 'Pound Sterling', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'real'        => 'R$ ' . _x( 'Real', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'ruble'       => '&#8381; ' . _x( 'Ruble', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'rupee'       => '&#8360; ' . _x( 'Rupee', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'inr'         => '&#8377; ' . _x( 'Rupee (Indian)', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'shekel'      => '&#8362; ' . _x( 'Shekel', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'yen'         => '&#165; ' . _x( 'Yen/Yuan', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'won'         => '&#8361; ' . _x( 'Won', 'Currency Symbol', 'wpmozo-addons-for-elementor-lite' ),
                'custom'      => esc_html__( 'Custom', 'wpmozo-addons-for-elementor-lite' ),
            ),
            'default' => 'dollar',
        )
    );
    ...
    $this->add_control( 'currency_symbol_custom',
        array(
            'label'     => esc_html__( 'Custom Symbol', 'wpmozo-addons-for-elementor-lite' ),
            'type'      => Controls_Manager::TEXT,
            'dynamic'   => array( 'active' => true ),
            'condition' => array(
    ...
    $this->add_control( 'table_price',
        array(
            'label'       => esc_html__( 'Price', 'wpmozo-addons-for-elementor-lite' ),
            'type'        => Controls_Manager::NUMBER,
            'min'         => 0,
            'max'         => 10000,
            'step'        => 1,
            'default'     => 139,
            'placeholder' => esc_html__( 'Enter your price', 'wpmozo-addons-for-elementor-lite' ),
        )
    );

    $this->add_control( 'currency_position',
        array(
            'label'   => esc_html__( 'Currency Symbol Position', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => array(
                'before' => array(
    ...
    $this->add_control( 'pricing_period',
        array(
            'label'       => esc_html__( 'Period', 'wpmozo-addons-for-elementor-lite' ),
            'type'        => Controls_Manager::TEXT,
            'dynamic'     => array( 'active' => true ),
            'default'     => __('Year','wpmozo-addons-for-elementor-lite'),
            'placeholder' => esc_html__( 'Enter your period', 'wpmozo-addons-for-elementor-lite' ),
        )
    );
...
//Features settings
$this->start_controls_section( 'features_content',
        array(
            'label' => esc_html__( 'Features', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_CONTENT,
        )
    );
    ...
    $repeater->add_control( 'list_feature',
        array(
            'label'       => esc_html__( 'Feature 1', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::TEXT,
            'dynamic'     => array( 'active' => true ),
            'default'     => esc_html__( 'Enter Feature', 'wpmozo-addons-for-elementor-lite' ),
            'placeholder' => esc_html__( 'Enter Feature', 'wpmozo-addons-for-elementor-lite' ),
        )
    );
    ...
    $repeater->add_control( 'enable_custom_styles',
        array(
            'label'        => esc_html__( 'Enable Custom Style', 'wpmozo-addons-for-elementor-lite' ),
    ...
    $repeater->add_control( 'feature_row_background_color',
        array(
            'label'       => esc_html__( 'Row Background', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
    ...
    $repeater->add_control( 'feature_list_heading',
        array(
            'label'     => esc_html__( 'Features', 'wpmozo-addons-for-elementor-lite' ),
    ...
    $repeater->add_control( 'features_list_text_color',
        array(
            'label'       => esc_html__( 'List Text Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#222',
            'selectors'   => array(
    ...
    $repeater->add_responsive_control( 'feature_list_font_size',
        array(
    ...
    $repeater->add_control( 'list_icon_heading',
        array(
            'label'     => esc_html__( 'Icon', 'wpmozo-addons-for-elementor-lite' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
    ...
    $repeater->add_control( 'list_icon_text_color',
        array(
    ...
    $repeater->add_group_control(
        ...
        array(
            ...
            'label'     => esc_html__( 'Icon Shadow', 'wpmozo-addons-for-elementor-lite' ),
    ...
    $this->add_control( 'features_list',
        array(
            'label'    => esc_html__( 'Features List', 'wpmozo-addons-for-elementor-lite' ),
            'type'     => Controls_Manager::REPEATER,
            'fields'   => $repeater->get_controls(),
            'default'  => array(
                array(
                    'list_feature' => esc_html__( 'Feature #1', 'wpmozo-addons-for-elementor-lite' ),
                    'list_icon'    => 'fa fa-caret-right',
                ),
                array(
                    'list_feature' => esc_html__( 'Feature #2', 'wpmozo-addons-for-elementor-lite' ),
                    'list_icon'    => 'fa fa-caret-right',
                ),
                array(
                    'list_feature' => esc_html__( 'Feature #3', 'wpmozo-addons-for-elementor-lite' ),
                    'list_icon'    => 'fa fa-caret-right',
                ),
            ),
...
$this->start_controls_section( 'button_content',
    ...
    $this->add_control( 'button_text',
        array(
            ...
            'type'        => Controls_Manager::TEXT,
            'dynamic'     => array( 'active' => true ),
            'default'     => esc_html__( 'Click Here', 'wpmozo-addons-for-elementor-lite' ),
        )
    );
...
//Style tab
//Global alignment
$this->start_controls_section( 'global_alingment',
        array(
            'label' => esc_html__( 'Global Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        )
    );

    $this->add_control( 'global_alignment',
        array(
            ...
            'options' => array(
                ...
                'justify' => array(
                    'title' => esc_html__( 'Justify', 'wpmozo-addons-for-elementor-lite' ),
...
$this->start_controls_section( 'title_settings',
    ...
    $this->add_control( 'title_heading_level',
        array(
            'label'       => esc_html__( 'Heading Level', 'wpmozo-addons-for-elementor-lite' ),
            'type'        => Controls_Manager::CHOOSE,
            'label_block' => true,
            'options'     =>
            array(
    ...
    $this->add_group_control(
        ...
        array(
            ...
            'label'    => esc_html__( 'Background Title', 'wpmozo-addons-for-elementor-lite' ),
...
$this->start_controls_section( 'subtitle_settings',
        array(
            'label' => esc_html__( 'Subtitle Styling', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        )
    );

    $this->add_control( 'subtitle_text_color',
        array(
            'label'       => esc_html__( 'Text Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
    ...
    $this->add_control( 'subtitle_text_alignment',
        array(
            'label'   => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => array(
    ...
    $this->add_group_control(
        ...
        array(
            ...
            'label'    => esc_html__( 'Background Subtitle', 'wpmozo-addons-for-elementor-lite' ),
            'types'    => array( 'classic', 'gradient', ),
            'selector' => '{{WRAPPER}} .wpmozo_ae_pricing_table_subtitle',
        )
    );
    ...
    $this->start_controls_tabs( 'subtitle_padding_margin_control_tabs');
        ...
        //Tab 1
        $this->start_controls_tab( 'subtitle_padding_tab',
                array(
                    'label' => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
        ...
        //Tab 2
        $this->start_controls_tab( 'subtitle_margin_tab',
                array(
                    'label' => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
    ...
    $this->add_control( 'underline_color',
        array(
            'label'       => esc_html__( 'Underline Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#000',
            'selectors'   => array(
    ...
    $this->add_control( 'underline_thickness',
        array(
            'label'       => esc_html__( 'Underline Thickness', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px' ),
            'range'       => array(
    ...
    $this->add_control( 'underline_width',
        array(
            'label'       => esc_html__( 'Underline Width', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px', '%' ),
            'range'       => array(
...
//Icon styling
$this->start_controls_section( 'header_icon_settings',
        array(
            'label'     => esc_html__( 'Icon Styling', 'wpmozo-addons-for-elementor-lite' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition'	=>	array( 
                'header_graphics' => 'icon',
            ),
    ...
    $this->add_control( 'header_icon_alignment',
        array(
            'label'   => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => array(
    ...
    $this->add_control( 'header_icon_size',
        array(
            'label'       => esc_html__( 'Size', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px' ),
            'range'       => array(
    ...
    //Tab 1
    $this->start_controls_tab( 'header_icon_padding_tab',
            array(
                'label' => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
            )
        );
        ...
        //Settings for first tab
        $this->add_responsive_control( 'header_icon_padding',
            array(
                'label'      => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', 'em', '%' ),
        ...
        //Tab 2
        $this->start_controls_tab( 'header_icon_margin_tab',
                array(
                    'label' => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
            ...
            //Settings for second tab
            $this->add_responsive_control( 'header_icon_margin',
                array(
                    'label'      => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => array( 'px', 'em', '%' ),
    ...
    $this->add_control( 'header_icon_hover_animation',
        array(
    ...
    $this->add_responsive_control( 'header_icon_animation_duration',
        array(
            'type'  => Controls_Manager::SLIDER,
            'label' => esc_html__( 'Animation Duration (ms)', 'wpmozo-addons-for-elementor-lite' ),
            'range' => array(
                'ms' => array(
                    'min' => 0,
                    'max' => 10000,
...
//Image styling
$this->start_controls_section( 'header_image_settings',
        array(
            'label'     => esc_html__( 'Image Styling', 'wpmozo-addons-for-elementor-lite' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition'	=> array( 
                'header_graphics' => 'image',
            ),
    ...
    $this->add_control( 'header_image_alignment',
        array(
            'label'	  => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'type'	  => Controls_Manager::CHOOSE,
            'options' => array(
    ...
    $this->add_responsive_control( 'header_image_border_radius',
        array(
    ...
    $this->start_controls_tabs( 'header_image_padding_margin_control_tabs');
        ...
        //Tab 1
        $this->start_controls_tab( 'header_image_padding_tab',
            array(
                'label' => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
            )
        );
            ...
            //Settings for first tab
            $this->add_responsive_control( 'header_image_padding',
                array(
                    'label'      => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => array( 'px', 'em', '%' ),
        ...
        //Tab 2
        $this->start_controls_tab( 'header_image_margin_tab',
            array(
                'label' => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
            )
        );
        ...
        //Settings for second tab
        $this->add_responsive_control( 'header_image_margin',
            array(
                'label'      => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', 'em', '%' ),
    ...
    $this->add_control( 'header_image_hover_animation',
        array(
            'label' => esc_html__( 'Hover Animation', 'wpmozo-addons-for-elementor-lite' ),
            'type'  => Controls_Manager::HOVER_ANIMATION,
        )
    ...
    $this->add_responsive_control( 'header_image_animation_duration',
        array(
            'type'  => Controls_Manager::SLIDER,
            'label' => esc_html__( 'Animation Duration (ms)', 'wpmozo-addons-for-elementor-lite' ),
            'range' => array(
...
//Pricing styling
$this->start_controls_section( 'pricing_settings',
        array(
            'label' => esc_html__( 'Pricing Styling', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        )
    );

    $this->add_control( 'currency_text_color',
        array(
            'label'       => esc_html__( 'Currency Text Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#222',
            'selectors'   => array(
    ...
    $this->add_group_control(
        Group_Control_Typography::get_type(),
        array(
            'label'       => esc_html__( 'Currency Typography', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
    ...
    $this->add_control( 'price_text_color',
        array(
            'label'       => esc_html__( 'Price Text Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#222',
            'selectors'   => array(
    ...
    $this->add_group_control(
        Group_Control_Typography::get_type(),
        array(
            'label'       => esc_html__( 'Price Typography', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
    ...
    $this->add_control( 'period_text_color',
        array(
            'label'       => esc_html__( 'Period Text Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#8F8F8F',
            'selectors'   => array(
    ...
    $this->add_group_control(
        Group_Control_Typography::get_type(),
        array(
            'label'       => esc_html__( 'Period Typography', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
    ...
    $this->add_control( 'period_slash_size',
        array(
            'label'       => esc_html__( 'Period Slash Size (px)', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px' ),
            'separator'   => 'before',
    ...
    $this->add_control( 'period_slash_color',
        array(
            'label'       => esc_html__( 'Period Slash Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '',
            'selectors'   => array(
    ...
    $this->add_control( 'pricing_text_alignment',
        array(
            'label'   => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => array(
    ...
    $this->add_control( 'pricing_section_padding_margin_heading',
        array(
    ...
    $this->start_controls_tabs( 'pricing_section_padding_margin_control_tabs');
        ...
        //Tab 1
        $this->start_controls_tab( 'pricing_section_padding_tab',
                array(
                    'label' => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
            ...
            //Settings for first tab
            $this->add_responsive_control( 'pricing_section_padding',
                array(
                    'label'      => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => array( 'px', 'em', '%' ),
        ...
        //Tab 2
        $this->start_controls_tab( 'pricing_section_margin_tab',
                array(
                    'label' => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
            ...
            //Settings for second tab
            $this->add_responsive_control( 'pricing_section_margin',
                array(
                    'label'      => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => array( 'px', 'em', '%' ),
...
$this->start_controls_section( 'features_settings',
        array(
            'label' => esc_html__( 'Features Styling', 'wpmozo-addons-for-elementor-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        )
    );

    $this->add_control( 'features_list_alignment',
        array(
            'label'   => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
            'type'    => Controls_Manager::CHOOSE,
            'options' => array(
    ...
    $this->add_control( 'list_icon_global_color',
        array(
            'label'       => esc_html__( 'Icons Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#00DB05',
            'selectors'   => array( '
    ...
    $this->add_responsive_control( 'list_icon_spacing_slider',
        array(
            'label' => esc_html__( 'Icon Spacing', 'wpmozo-addons-for-elementor-lite' ),
            'type'  => Controls_Manager::SLIDER,
            'range' => array(
                'px' => array(
                    'max'  => 50,
    ...
    $this->add_control( 'features_list_padding_margin_heading',
        array(
            'label' => esc_html__( 'Margin and Padding', 'wpmozo-addons-for-elementor-lite' ),
            'type'  => Controls_Manager::HEADING,
        )
    );
    ...
    $this->start_controls_tabs( 'features_list_padding_margin_control_tabs');
        ...
        //Tab 1
        $this->start_controls_tab( 'features_list_padding_tab',
            array(
                'label' => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
            )
        );
            ...
            //Settings for first tab
            $this->add_responsive_control( 'features_list_padding',
                array(
                    'label'      => esc_html__( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => array( 'px', 'em', '%' ),
        ...
        //Tab 2
        $this->start_controls_tab( 'features_list_margin_tab',
                array(
                    'label' => esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                )
            );
            ...
            //Settings for second tab
            $this->add_responsive_control( 'features_list_margin',
                array(
                    'label'			=> esc_html__( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
                    'type' 			=> Controls_Manager::DIMENSIONS,
                    'size_units'	=> array( 'px', 'em', '%' ),
    ...
    $this->add_control( 'divider_color',
        array(
            'label'       => esc_html__( 'Divider Color', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => false,
            'type'        => Controls_Manager::COLOR,
            'default'     => '#dedede',
            'separator'   => 'before',
    ...
    $this->add_control( 'divider_size',
        array(
            'label'       => esc_html__( 'Divider Size', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px' ),
            'range'       => array(
    ...
    $this->add_control( 'divider_thickness',
        array(
            'label'       => esc_html__( 'Divider Thickness', 'wpmozo-addons-for-elementor-lite' ),
            'label_block' => true,
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px' ),
            'range'       => array(
...
$this->start_controls_section( 'button_settings',
    ...
    $this->start_controls_tabs( 'button_normal_and_hover_state_control_tabs');
        ...
        $this->start_controls_tab( 'button_hover_state_tab',
            ...
            $this->add_responsive_control( 'button_hover_state_font_size',
                array(
                    'type'  => Controls_Manager::SLIDER,
                    'label' => esc_html__( 'Font Size', 'wpmozo-addons-for-elementor-lite' ),
                    'range' => array(
