...
// Content tab.
// Gallery items.
$this->start_controls_section( 'masonry_gallery_settings',
	array(
		'label' => esc_html__( 'Gallery Setting', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control( 'gallery',
		array(
			'label'      => esc_html__( 'Add Gallery Images', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_responsive_control( 'select_number_of_column',
		array(
			'label'          => __( 'Number Of Columns', 'wpmozo-addons-for-elementor-lite' ),
			'label_block'    => false,
	...
	$this->add_responsive_control( 'column_spacing_slider',
		array(
			'label'          => esc_html__( 'Column Spacing', 'wpmozo-addons-for-elementor-lite' ),
...
// Gallery elements
$this->start_controls_section( 'masonry_gallery_elements_settings',
	array(
		'label' => esc_html__( 'Elements', 'wpmozo-addons-for-elementor-lite' ),
		'tab'   => Controls_Manager::TAB_CONTENT,
	)
);

	$this->add_control( 'image_title_switcher',
		array(
			'label'                => esc_html__( 'Show Title', 'wpmozo-addons-for-elementor-lite' ),
			'separator'            => 'before',
	...
	$this->add_control( 'title_show_select',
		array(
			'label'       => __( 'Show Title in', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_title_lightbox_only' => __( 'Lightbox', 'wpmozo-addons-for-elementor-lite' ),
				'wpmozo_title_gallery_only'  => __( 'Gallery', 'wpmozo-addons-for-elementor-lite' ),
				'wpmozo_title_both'          => __( 'Both', 'wpmozo-addons-for-elementor-lite' ),
			),
	...
	$this->add_control( 'caption_switcher',
		array(
			'label'                => esc_html__( 'Show Caption', 'wpmozo-addons-for-elementor-lite' ),
			'separator'            => 'before',
			'type'                 => Controls_Manager::SWITCHER,
			'label_off'            => esc_html__( 'NO', 'wpmozo-addons-for-elementor-lite' ),
			'label_on'             => esc_html__( 'YES', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control( 'caption_show_select',
		array(
			'label'       => __( 'Show Caption in', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_caption_lightbox_only' => __( 'Lightbox', 'wpmozo-addons-for-elementor-lite' ),
				'wpmozo_caption_gallery_only'  => __( 'Gallery', 'wpmozo-addons-for-elementor-lite' ),
				'wpmozo_caption_both'          => __( 'Both', 'wpmozo-addons-for-elementor-lite' ),
			),
	...
	$this->add_control( 'lightbox_switcher',
		array(
			'label'                => esc_html__( 'Enable Lightbox', 'wpmozo-addons-for-elementor-lite' ),
			'separator'            => 'before',
			'type'                 => Controls_Manager::SWITCHER,
			'label_off'            => esc_html__( 'NO', 'wpmozo-addons-for-elementor-lite' ),
			'label_on'             => esc_html__( 'YES', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control( 'title_caption_style_select',
		array(
			'label'       => __( 'Title & Caption Style in Lightbox', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_ae_masonry_gallery_img_ovl' => __( 'Image Overlay', 'wpmozo-addons-for-elementor-lite' ),
				'wpmozo_ae_masonry_gallery_img_blw' => __( 'Below Image', 'wpmozo-addons-for-elementor-lite' ),
			),
	...
	$this->add_control( 'overlay_on_hover_switcher',
		array(
			'label'                => esc_html__( 'Overlay on Hover', 'wpmozo-addons-for-elementor-lite' ),
			'separator'            => 'before',
			'type'                 => Controls_Manager::SWITCHER,
			'label_off'            => esc_html__( 'NO', 'wpmozo-addons-for-elementor-lite' ),
			'label_on'             => esc_html__( 'YES', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control( 'overlay_icon_select',
		array(
			'label'     => esc_html__( 'Overlay Icon', 'wpmozo-addons-for-elementor-lite' ),
...
// Style tab.
// Gallery styling.
$this->start_controls_section( 'gallery_styling_section',
	array(
		'label' => esc_html__( 'Gallery Styling', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_responsive_control( 'gallery_image_border_radius',
		array(
			'label'      => esc_html__( 'Image Rounded Corners', 'wpmozo-addons-for-elementor-lite' ),
...
$this->start_controls_section( 'title_styling_section',
	...
	$this->start_controls_tabs( 'title_normal_and_hover_state_control_tab'
		...
		$this->start_controls_tab( 'title_hover_state_tab',
			...
			$this->add_control( 'title_text_hover_state_color',
				array(
					'label'       => esc_html__( 'Title Text Color', 'wpmozo-addons-for-elementor-lite' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'default'     => '',
					'selectors'   => array(
			...
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
				array(
					...
					'label'     => esc_html__( 'Title Text Shadow', 'wpmozo-addons-for-elementor-lite' ),
					'selector'  => '{{WRAPPER}} .wpmozo_ae_masonry_gallery_item_title:hover',
					'separator' => 'before',
				)
			);
	...
	$this->add_control( 'title_padding_margin_heading',
		array(
			'label' => esc_html__( 'Title Padding and Margin', 'wpmozo-addons-for-elementor-lite' ),
...
$this->start_controls_section( 'caption_styling_section',
	array(
		'label' => esc_html__( 'Caption', 'wpmozo-addons-for-elementor-lite' ),
		'tab'   => Controls_Manager::TAB_STYLE,
		'condition' => array( 'caption_switcher' => 'yes' )
	)
);
	...
	$this->start_controls_tabs( 'caption_normal_and_hover_state_control_tab'
		...
		$this->start_controls_tab( 'caption_normal_state_tab',
			...
			$this->add_control( 'caption_text_color',
				array(
					'label'       => esc_html__( 'Caption Text Color', 'wpmozo-addons-for-elementor-lite' ),
					'label_block' => false,
					'type'        => Controls_Manager::COLOR,
					'default'     => '#222',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array(
					'label'       => esc_html__( 'Caption Typography', 'wpmozo-addons-for-elementor-lite' ),
					'label_block' => true,
			...
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
				array(
					...
					'label'     => esc_html__( 'Caption Text Shadow', 'wpmozo-addons-for-elementor-lite' ),
					'selector'  => '{{WRAPPER}} .wpmozo_ae_masonry_gallery_item_caption',
					'separator' => 'before',
				)
			);
	...
	$this->add_control( 'caption_text_alignment',
		array(
			'label'       => esc_html__( 'Caption Alignment', 'wpmozo-addons-for-elementor-lite' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => true,
			'options'     => array(
				'left'   => array(
					'caption' => esc_html__( 'Left', 'wpmozo-addons-for-elementor-lite' ),
					'icon'    => 'eicon-text-align-left',
				),
				'center' => array(
					'caption' => esc_html__( 'Center', 'wpmozo-addons-for-elementor-lite' ),
					'icon'    => 'eicon-text-align-center',
				),
				'right'  => array(
					'caption' => esc_html__( 'Right', 'wpmozo-addons-for-elementor-lite' ),
					'icon'    => 'eicon-text-align-right',
				),
			),
			'default'     => is_rtl() ? 'right' : 'left',
	...
	$this->add_control( 'caption_padding_margin_heading',
		array(
			'label' => esc_html__( 'Caption Padding and Margin', 'wpmozo-addons-for-elementor-lite' ),
			'type'  => Controls_Manager::HEADING,
...
// Lightbox styling.
$this->start_controls_section( 'lightbox_styling_section',
	array(
		'label'     => esc_html__( 'Lightbox', 'wpmozo-addons-for-elementor-lite' ),
		'tab'       => Controls_Manager::TAB_STYLE,
	...
	$this->add_control( 'lightbox_background_color',
		array(
			'label'       => esc_html__( 'Lightbox Background Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#0000006E',
			'selectors'   => array(
	...
	$this->add_control( 'exit_icon_color',
		array(
			'label'       => esc_html__( 'Exit Icon Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#ffffff',
			'selectors'   => array(
	...
	$this->add_control( 'arrows_color',
		array(
			'label'       => esc_html__( 'Arrow Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#ffffff',
			'selectors'   => array(
	...
	$this->add_control( 'arrow_border_color',
		array(
			'label'       => esc_html__( 'Arrow Border Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#FFFFFF75',
			'selectors'   => array(
	...
	$this->add_control( 'title_and_caption_color',
		array(
			'label'       => esc_html__( 'Title & Caption Background Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#FFFFFF75',
			'selectors'   => array(
				'{{WRAPPER}} .mfp-title > .wpmozo_ae_masonry_gallery_item_title , {{WRAPPER}} .mfp-title > .wpmozo_ae_masonry_gallery_item_caption , {{WRAPPER}} .mfp-title' => 'background-color: {{VALUE}};',
			),
		)
	);
...
// Overlay styling.
$this->start_controls_section( 'overlay_styling_section',
	array(
	...
	$this->add_responsive_control( 'overlay_icon_size_slider',
		array(
	...
	$this->add_control( 'overlay_icon_color',
		array(
			'label'       => esc_html__( 'Overlay Icon Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#ffffff',
			'selectors'   => array(
	...
	$this->add_control( 'image_overlay_color',
		array(
			'label'       => esc_html__( 'Overlay Background Color', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => false,
			'type'        => Controls_Manager::COLOR,
			'default'     => '#0000006E',
			'selectors'   => array(
