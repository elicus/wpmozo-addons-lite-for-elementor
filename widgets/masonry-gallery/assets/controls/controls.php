...
$this->start_controls_section(
	...
	$this->add_control(
		...
		array(
			...
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_title_lightbox_only' => esc_html__( 'Lightbox', 'wpmozo-addons-lite-for-elementor' ),
				'wpmozo_title_gallery_only'  => esc_html__( 'Gallery', 'wpmozo-addons-lite-for-elementor' ),
				'wpmozo_title_both'          => esc_html__( 'Both', 'wpmozo-addons-lite-for-elementor' ),
			),
	...
	$this->add_control(
		'caption_show_select',
		array(
			'label'       => esc_html__( 'Show Caption in', 'wpmozo-addons-lite-for-elementor' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_caption_lightbox_only' => esc_html__( 'Lightbox', 'wpmozo-addons-lite-for-elementor' ),
				'wpmozo_caption_gallery_only'  => esc_html__( 'Gallery', 'wpmozo-addons-lite-for-elementor' ),
				'wpmozo_caption_both'          => esc_html__( 'Both', 'wpmozo-addons-lite-for-elementor' ),
			),
	...
	$this->add_control(
		...
		array(
			'label'       => esc_html__( 'Title & Caption Style in Lightbox', 'wpmozo-addons-lite-for-elementor' ),
			'label_block' => false,
			'type'        => Controls_Manager::SELECT,
			'options'     => array(
				'wpmozo_ae_masonry_gallery_img_ovl' => esc_html__( 'Image Overlay', 'wpmozo-addons-lite-for-elementor' ),
				'wpmozo_ae_masonry_gallery_img_blw' => esc_html__( 'Below Image', 'wpmozo-addons-lite-for-elementor' ),
			),
