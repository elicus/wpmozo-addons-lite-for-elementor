	...
	$this->start_controls_tabs(
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'before_label_text',
				array(
					'label'       => esc_html__( 'Enter Lable', 'wpmozo-addons-lite-for-elementor' ),
					'label_block' => true,
					'type'        => Controls_Manager::TEXT,
					'dynamic'     => array( 'active' => true ),
					'placeholder' => esc_html__( 'Enter Label For Before Image', 'wpmozo-addons-lite-for-elementor' ),
					'condition'   => array( 'before_label_show_switcher' => 'yes' ),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'type'        => Controls_Manager::TEXT,
					'dynamic'     => array( 'active' => true ),
					'placeholder' => esc_html__( 'Enter Label For After Image', 'wpmozo-addons-lite-for-elementor' ),
					'condition'   => array( 'after_label_show_switcher' => 'yes' ),
				)
			);
			...
			$this->add_control(
				...
				array(
					'label'       => esc_html__( 'Slider Orientation', 'wpmozo-addons-lite-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::SELECT,
					'options'     => array(
						''         => esc_html__( 'Horizontal', 'wpmozo-addons-lite-for-elementor' ),
