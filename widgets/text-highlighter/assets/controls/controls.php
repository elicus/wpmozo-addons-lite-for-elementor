...
$this->start_controls_section(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_text_highlighter_inner_wrapper svg path' => 'fill: {{VALUE}};stroke: {{VALUE}};',
			),
			'default'   => '#2B87DA',
		)
	);
	...
	$this->add_responsive_control(
		'custom_vertical_position_for_highlighter',
		array(
	...
	$this->add_responsive_control(
		'custom_horizontal_position_for_highlighter',
		array(
