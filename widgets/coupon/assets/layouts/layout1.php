...
<div class="dipl_coupon_inner">
	...
	<div class="dipl_coupon_code_wrapper">
		<?php if ( !empty( $coupon_code ) ) { ?>
			<div class="dipl_coupon_code"><span class="dipl_coupon_code_text"><?php echo esc_html( $coupon_code ); ?></span></div>
		<?php } ?>
		<?php if ( 'yes' === $show_expiry_date && ! empty( $expiry_text ) ) { ?>
			<div class="dipl_coupon_expiry_message <?php echo esc_attr( $expiry_class ); ?>">
