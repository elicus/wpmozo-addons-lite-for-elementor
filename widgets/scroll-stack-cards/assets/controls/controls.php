...
$repeater = new Repeater();
	...
	$repeater->add_group_control(
		...
		array(
			...
			'toggle'         => false,
			'selector'       => '{{WRAPPER}} .dipl_scroll_stack_cards .dipl_scroll_stack_cards_item{{CURRENT_ITEM}}',
		)
	);
	$this->add_control(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .dipl_scroll_stack_cards_title' => 'text-align: {{VALUE}};',
			),
		)
	);
	...
	$this->add_group_control(
		...
		array(
			...
			'selector' => '{{WRAPPER}} .dipl_scroll_stack_cards_title',
		)
	);
	$this->add_responsive_control(
		'title_text_size',
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .dipl_scroll_stack_cards_title' => 'font-size: {{SIZE}}{{UNIT}}; transition: all 300ms;',
			),
		)
	);
	$this->add_responsive_control(
		...
		array(
			...
			'separator' => 'after',
			'selectors' => array(
				'{{WRAPPER}} .dipl_scroll_stack_cards_title' => 'color: {{VALUE}}; transition: 300ms;',
			),
		)
	);
	...
	$this->add_group_control(
		...
		array(
			...
			'label'    => esc_html__( 'Typography', 'wpmozo-addons-lite-for-elementor' ),
			'exclude'     => array( 'font_size' ),
			'selector' => '{{WRAPPER}} .dipl_scroll_stack_cards_title:hover',
		)
	);
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .dipl_scroll_stack_cards_title:hover' => 'font-size: {{SIZE}}{{UNIT}}; transition: all 300ms;',
			),
		)
	);
	$this->add_responsive_control(
		...
		array(
			...
			'separator' => 'after',
			'selectors' => array(
				'{{WRAPPER}} .dipl_scroll_stack_cards_title:hover' => 'color: {{VALUE}};',
			),
		)
	);
	$this->end_controls_tab();
		...
		$this->start_controls_tab( 'description_text_tab',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content > p:not( :has( a ) )',
				)
			);
			$this->add_responsive_control( 'description_text__color',
				array( 
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content',
				)
			);
			$this->add_responsive_control( 'description_text_alignment',
				array( 
					...
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content' => 'text-align: {{VALUE}};',
					),
				)
			);
		$this->end_controls_tab();
		$this->start_controls_tab( 'description_link_tab',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content a',
				)
			);
			$this->add_responsive_control( 'description_link_color',
				array( 
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content a' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
			...
			$this->add_responsive_control( 'description_link_alignment',
				array( 
					...
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content p:has( a )' => 'text-align: {{VALUE}};',
					),
				)
			);
		$this->end_controls_tab();
		$this->start_controls_tab( 'description__unordered_list_tab',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content ul',
				)
			);
			$this->add_responsive_control( 'description__unordered_list_color',
				array( 
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content ul' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
			...
			$this->add_responsive_control( 'description__unordered_list_alignment',
				array( 
					...
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content ul' => 'text-align: {{VALUE}};',
					),
				)
			);
		$this->end_controls_tab();
		$this->start_controls_tab( 'description_ordered_list_tab',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content ol',
				)
			);
			$this->add_responsive_control( 'description_ordered_list_color',
				array( 
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content ol' => 'color: {{VALUE}};',
					),
				)
			);
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
			...
			$this->add_responsive_control( 'description_ordered_list_alignment',
				array( 
					...
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content ol' => 'text-align: {{VALUE}};',
					),
				)
			);
		$this->end_controls_tab();
		$this->start_controls_tab( 'description_blockquote_tab',
			...
			$this->add_group_control( Group_Control_Typography::get_type(),
				array( 
					...
					'selector'    => '{{WRAPPER}} .dipl_scroll_stack_cards_content blockquote',
				)
			);
			$this->add_responsive_control( 'description_blockquote_color',
				array( 
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content blockquote' => 'color: {{VALUE}};',
						'{{WRAPPER}} .dipl_scroll_stack_cards_content blockquote p:before' => 'border-left: 5px solid {{VALUE}};',
					),
				)
			);
			$this->add_group_control( Group_Control_Text_Shadow::get_type(),
			...
			$this->add_responsive_control( 'description_blockquote_alignment',
				array( 
					...
					'selectors' => array( 
						'{{WRAPPER}} .dipl_scroll_stack_cards_content blockquote' => 'text-align: {{VALUE}};',
					),
				)
			);
		$this->end_controls_tab();
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array( 
				'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper span.wpmozo_icon' 	=> 'font-size: {{SIZE}}{{UNIT}}; transition: all 300ms;',
				'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper svg.wpmozo_icon' 	=> 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; transition: all 300ms;',
			),
		)
	);
	$this->start_controls_tabs( 'tag_styling_tabs' );
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper svg'   => 'fill: {{VALUE}}; transition: 300ms;',
					'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper i'     => 'color: {{VALUE}}; transition: 300ms;',
				),
			)
		);
		$this->end_controls_tab();
			...
			$this->add_control(
				...
				array(
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper svg:hover'   => 'fill: {{VALUE}}; transition: 300ms;',
						'{{WRAPPER}} .dipl_scroll_stack_cards_icon_wrapper i:hover'     => 'color: {{VALUE}}; transition: 300ms;',
					),
				)
			);
			$this->end_controls_tab();
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_image_wrapper img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_image_wrapper' => 'flex: 0 0 {{SIZE}}{{UNIT}} !important;',
					),
					'condition'  => array(
						'layout' => 'vertical',
					),
			...
			$this->start_controls_tabs( 'image_styling_tabs' );
				$this->start_controls_tab(
					...
					$this->add_group_control(
						...
						array(
							'name'           => 'image_border',
							'selector'       => '{{WRAPPER}} .dipl_scroll_stack_cards_image_wrapper img',
							'fields_options' => array(
					...
					$this->add_responsive_control(
						...
						array(
							...
							'separator'   => 'after',
							'selectors'   => array(
								'{{WRAPPER}} .dipl_scroll_stack_cards_image_wrapper img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};transition:all 300ms;',
							),
						)
					);
					$this->end_controls_tab();
					...
					$this->add_group_control(
						...
						array(
							...
							'selector'       => '{{WRAPPER}} .dipl_scroll_stack_cards_image_wrapper img:hover',
							'fields_options' => array(
								'border' => array( 'label' => esc_html__( 'Image Border Type', 'wpmozo-addons-lite-for-elementor' ) ),
								'width'  => array( 'label' => esc_html__( 'Image Border Width', 'wpmozo-addons-lite-for-elementor' ) ),
								'color'  => array( 'label' => esc_html__( 'Image Border Color', 'wpmozo-addons-lite-for-elementor' ) ),
					...
					$this->add_responsive_control(
						...
						array(
							...
							'separator'   => 'after',
							'selectors'   => array(
								'{{WRAPPER}} .dipl_scroll_stack_cards_image_wrapper img:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							),
						)
					);
					$this->end_controls_tab();
					...
					$this->add_responsive_control(
						...
						array(
							...
							'size_units' => array( 'px', '%', 'em', 'rem', 'custom' ),
							'selectors'  => array(
								'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							),
						)
					);
					$this->add_responsive_control(
						...
						array(
							...
							'selectors'  => array(
								'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper' => 'margin: {{SIZE}}{{UNIT}};',
							),
						)
					);
					$this->start_controls_tabs( 'content_styling_tabs' );
						...
						$this->add_control(
							...
							array(
								...
								'type'      => Controls_Manager::COLOR,
								'selectors' => array(
									'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper' => 'background-color: {{VALUE}}; transition: 300ms;',
								),
							)
						);
							$this->add_group_control(
								...
								array(
									...
									'selector'       => '{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper',
									'fields_options' => array(
							...
							$this->add_responsive_control(
								...
								array(
									...
									'size_units'  => array( 'px', 'em', '%' ),
									'selectors'   => array(
										'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};transition:all 300ms;',
									),
								)
							);
							$this->end_controls_tab();
							...
							$this->add_control(
								...
								array(
									...
									'type'      => Controls_Manager::COLOR,
									'selectors' => array(
										'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper:hover' => 'background-color: {{VALUE}}; transition: 300ms;',
									),
								)
							);
							$this->add_group_control(
								...
								array(
									...
									'selector'       => '{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper:hover',
									'fields_options' => array(
										'border' => array( 'label' => esc_html__( 'Content Wrap Border Type', 'wpmozo-addons-lite-for-elementor' ) ),
										'width'  => array( 'label' => esc_html__( 'Content Wrap Border Width', 'wpmozo-addons-lite-for-elementor' ) ),
										'color'  => array( 'label' => esc_html__( 'Content Wrap Border Color', 'wpmozo-addons-lite-for-elementor' ) ),
							...
							$this->add_responsive_control(
								...
								array(
									...
									'size_units'  => array( 'px', 'em', '%' ),
									'selectors'   => array(
										'{{WRAPPER}} .dipl-scroll-stack-cards-wrapper .dipl_scroll_stack_cards_content_wrapper:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
									),
								)
							);
							$this->end_controls_tab();
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards .layout-horizontal .dipl_scroll_stack_cards_item' => 'width: {{SIZE}}{{UNIT}};',
					),
					'condition' => array(
						'layout' => 'horizontal',
					),
			...
			$this->add_control(
				...
				array(
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_item' => 'background-color: {{VALUE}}; transition: 300ms;',
					),
				)
			);
			$this->add_group_control(
				...
				array(
					...
					'selector'       => '{{WRAPPER}} .dipl_scroll_stack_cards_item',
					'fields_options' => array(
			...
			$this->add_responsive_control(
				...
				array(
					...
					'separator'   => 'after',
					'selectors'   => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};transition:all 300ms;',
					),
				)
			);
			$this->end_controls_tab();
			...
			$this->add_control(
				...
				array(
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_item:hover' => 'background-color: {{VALUE}}; transition: 300ms;',
					),
				)
			);
			$this->add_group_control(
				...
				array(
					...
					'selector'       => '{{WRAPPER}} .dipl_scroll_stack_cards_item:hover',
					'fields_options' => array(
						'border' => array( 'label' => esc_html__( 'Card Item Border Type', 'wpmozo-addons-lite-for-elementor' ) ),
						'width'  => array( 'label' => esc_html__( 'Card Item Border Width', 'wpmozo-addons-lite-for-elementor' ) ),
						'color'  => array( 'label' => esc_html__( 'Card Item Border Color', 'wpmozo-addons-lite-for-elementor' ) ),
			...
			$this->add_responsive_control(
				...
				array(
					...
					'separator'   => 'after',
					'selectors'   => array(
						'{{WRAPPER}} .dipl_scroll_stack_cards_item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);
			$this->end_controls_tab();
