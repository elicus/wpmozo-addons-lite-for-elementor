...
?>
<div class="wpmozo_horizontal_scrolling_card_image_wrapper">
	<img decoding="async" src="<?php echo esc_attr( $item['card_item_image']['url'] ); ?>" alt="<?php echo esc_attr( $item['card_item_image_alt'] ); ?>" class="wpmozo_horizontal_scrolling_card_image">
