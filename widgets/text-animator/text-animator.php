	...
	class WPMOZO_AE_Text_Animator extends Widget_Base {
		...
		protected function render() {
			...
			$this->add_render_attribute(
				'animated_text',
				array(
					'class'                        => array( 'wpmozo_animated_text', 'wpmozo_main_part' ),
					'data-wait-time'               => $animation_delay,
					'data-animation-time'          => $animation_time,
					'data-text'                    => $settings['animated_text'],
					'data-stop-animation-on-hover' => $stop_animation,
				)
			);
			if ( 'typing' === $animation_type ) {
				$this->add_render_attribute(
					'animated_text',
					array(
						'data-typing-time'  => $typing_speed,
						'data-erasing-time' => $erasing_speed,
					)
				);
			}
			if ( '' !== $pre_text ) {
