...
$this->start_controls_section(
	'content_section_new',
	array(
		'label' => esc_html__( 'Logos', 'wpmozo-addons-lite-for-elementor' ),
	...
	$repeater->add_control(
		...
		array(
			...
			'default'     => esc_html__( 'List Title', 'wpmozo-addons-lite-for-elementor' ),
			'label_block' => true,
		)
	);
	...
	$repeater->start_controls_tabs(
		...
		$repeater->start_controls_tab(
			...
			$this->add_control(
				'logo_list',
				array(
					'label'       => esc_html__( 'Logo List', 'wpmozo-addons-lite-for-elementor' ),
					'type'        => Controls_Manager::REPEATER,
					'fields'      => $repeater->get_controls(),
					'default'     => array(
						array(
							'list_logo'     => esc_html__( 'Item Media', 'wpmozo-addons-lite-for-elementor' ),
							'logo_alt_text' => esc_html__( 'Item 1', 'wpmozo-addons-lite-for-elementor' ),


						),
						array(
							'list_image'    => esc_html__( 'Item Media', 'wpmozo-addons-lite-for-elementor' ),
							'logo_alt_text' => esc_html__( 'Item 2', 'wpmozo-addons-lite-for-elementor' ),

						),
						array(
							'list_image'    => esc_html__( 'Item Media', 'wpmozo-addons-lite-for-elementor' ),
							'logo_alt_text' => esc_html__( 'Item 3', 'wpmozo-addons-lite-for-elementor' ),
			...
			$this->add_control(
				'logo_align',
				array(
					'label'       => esc_html__( 'Logo Alignment', 'wpmozo-addons-lite-for-elementor' ),
					'label_block' => false,
					'type'        => Controls_Manager::SELECT,
					'separator'   => 'after',
					'options'     => array(
