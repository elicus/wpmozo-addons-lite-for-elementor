...
$this->start_controls_section(
	...
	$this->add_control(
		...
		array(
			'label'     => esc_html__( 'Bar Background Color', 'wpmozo-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '#f5f5f5',
			'selectors' => array(
	...
	$this->add_group_control(
		...
		array(
			...
			'fields_options' 	=> array(
				'border' 			=> array(
					'label' 		=> esc_html__( 'Bar Border', 'wpmozo-addons-lite-for-elementor' ),
				),
				'width' 			=> array(
					'label' 		=> esc_html__( 'Bar Border Width', 'wpmozo-addons-lite-for-elementor' ),
				),
				'color' 			=> array(
					'label' 		=> esc_html__( 'Bar Border Color', 'wpmozo-addons-lite-for-elementor' ),
				),
			),
		)
	);
	$this->add_responsive_control(
		...
		array(
			'label'      => esc_html__( 'Bar Border Radius', 'wpmozo-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em', 'rem', 'custom' ),
			'selectors'  => array(
	...
	$this->end_controls_tab();
	$this->end_controls_tabs();
	$this->start_controls_tabs( 'post_margin_padding_tabs', array( 'separator' => 'before' ) );

	// Tab 2.
	$this->start_controls_tab( 
		'bar_margin_tab',
		array( 
			'label' => esc_html__( 'Bar Margin', 'wpmozo-addons-lite-for-elementor' ),
		 )
	 );
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Bar Margin', 'wpmozo-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
	...
	$this->start_controls_tab( 
		...
		$this->add_responsive_control(
			'post_item_padding',
			array(
				'label'      => esc_html__( 'Item Padding', 'wpmozo-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_arrows_position i:before' => 'font-size: {{SIZE}}{{UNIT}};',
	...
	$this->add_control(
		...
		array(
			'label'     => esc_html__( 'Container Background Color', 'wpmozo-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
	...
	$this->add_responsive_control(
		...
		array(
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				'{{WRAPPER}} .wpmozo_post_ticker_bar .wpmozo_swiper_navigation .swiper-button-next,{{WRAPPER}} .wpmozo_post_ticker_bar .wpmozo_swiper_navigation .swiper-button-prev' => 'color: {{VALUE}}; transition:all 300ms;',
