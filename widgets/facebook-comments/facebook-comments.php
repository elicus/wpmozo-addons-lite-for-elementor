...
if ( ! class_exists( 'WPMOZO_AE_Facebook_Comments' ) ) {
	class WPMOZO_AE_Facebook_Comments extends Widget_Base {
		...
		public function get_keywords() {
			return array( 'wpmz facebook comments','wpmozo facebook comments','wpmz social media widgets','wpmozo social media widgets','wpmz comments','wpmozo comments' );
		}
		...
		protected function register_controls() {
			...
			require plugin_dir_path( dirname( __FILE__ ) ) . 'facebook-comments/assets/controls/controls.php';
		}
		/**
