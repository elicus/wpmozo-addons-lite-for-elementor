                ...
                <?php if ( 'use_hexagon' === $icon_shape ) { ?>
                                    <div class="hexagon_wrapper">
                                        <div class="hex">
                                            ...
                                            <?php \Elementor\Icons_Manager::render_icon( $item[ 'item_thumbnail_icon' ], [ 'aria-hidden' => 'true', 'class' => 'wpmozo_price_list_icon wpmozo_icon wpmozo_hex' ], 'span' ); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php } else { ?>
                    <?php \Elementor\Icons_Manager::render_icon( $item[ 'item_thumbnail_icon' ], [ 'aria-hidden' => 'true', 'class' => 'wpmozo_price_list_icon wpmozo_icon' ], 'span' ); ?>
                    <?php } ?>
                </div>
            <?php } ?>
                <div class="wpmozo_price_list_item_price_wrap">
                    <div class="wpmozo_price_list_item_currency_with_price">
                        <span class="wpmozo_price_list_item_currency"><?php echo esc_html( $item[ 'item_currency' ] ); ?></span>
                        <span class="wpmozo_price_list_item_price"><?php echo esc_html( $item[ 'item_price' ] ); ?></span>
                    </div>
                    <span class="wpmozo_price_list_item_price_period">
                    <?php if ( '' !== $item[ 'item_price_period' ] ) { ?><span class="wpmozo_price_period_divider">/</span><?php echo esc_html( $item[ 'item_price_period' ] ); } ?>
                    </span>
                </div>
                ...
                <div class="wpmozo_price_list_item_description">
                    <p><span><?php echo wp_kses_post( $item[ 'item_content' ] ); ?></span></p>
                </div>
            </div>
        </div>
    <?php } ?>
