            ...
            <div class="wpmozo_price_list_item_wrap">
                ...
                <div class="wpmozo_price_list_item_details">
                    <div class="wpmozo_price_list_item_title_wrap">
                        ...
                        <div class="wpmozo_price_list_item_price_period"><?php if ( '' !== $item[ 'item_price_period' ] ) { ?><span class="wpmozo_price_period_divider">/</span><?php echo esc_html( $item[ 'item_price_period' ] );
                                                                                                                                                                        } ?></div>
                    </div>
