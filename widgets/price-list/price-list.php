...
if ( ! class_exists( 'WPMOZO_AE_Price_List' ) ) {
	class WPMOZO_AE_Price_List extends Widget_Base {
		...
		public function get_keywords() {
			return array( 'wpmz price list','wpmozo price list','wpmz menu list','wpmozo menu list','wpmz pricing list','wpmozo pricing list' );
		}
		...
		protected function register_controls() {
			...
			require_once plugin_dir_path( __DIR__ ) . 'price-list/assets/controls/controls.php';
		}
		...
		protected function render() {
			...
			<?php
			if ( 'layout1' === $layout ) {
				if ( file_exists( plugin_dir_path( __DIR__ ) . "price-list/assets/layouts/$layout.php" ) ) {
					include plugin_dir_path( __DIR__ ) . "price-list/assets/layouts/$layout.php";
				}
