 ...
 *
 * This template can be overridden by copying it to yourtheme/wpmozo-ae-for-elementor/layouts/testimonial-slider/layout1.php
 *
...
<div id="wpmozo_single_testimonial_<?php echo esc_attr( $testimonial_id ); ?>" class="wpmozo_single_testimonial_card">
	<div class="wpmozo_testimonial_desc">
		<?php if ( 'yes' === $show_opening_quote_icon ): ?>
            <span class="wpmozo_testimonial_quote_icon wpmozo_testimonial_opening_quote_icon eicon-editor-quote
"></span>
        <?php endif; ?>
	...
	<div class="wpmozo_testimonial_meta">
		...
		<?php if ( isset( $testimonial_author ) && '' !== $testimonial_author ): ?>
