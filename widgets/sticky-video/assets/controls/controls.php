...
$this->add_responsive_control(
	...
	array(
		...
		'type'      => Controls_Manager::COLOR,
		'selectors' => array(
			'{{WRAPPER}} .wpmozo_sticky_video .wpmozo_video_play span.wpmozo_play_icon:hover' => 'color: {{VALUE}};',
			'{{WRAPPER}} .wpmozo_sticky_video .wpmozo_video_play svg.wpmozo_play_icon:hover' => 'fill: {{VALUE}};',
		),
	)
);
$this->add_responsive_control(
	...
	array(
		...
		'selectors'  => array(
			'{{WRAPPER}} .wpmozo_sticky_video .wpmozo_video_play span.wpmozo_play_icon:hover' => 'font-size: {{SIZE}}{{UNIT}};',
			'{{WRAPPER}} .wpmozo_sticky_video .wpmozo_video_play svg.wpmozo_play_icon:hover' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
		),
		'condition'  => array(
			'custom_icon_size' => 'yes',
		),
