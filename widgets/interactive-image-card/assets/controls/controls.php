...
//Content tab 
//Content controls 
$this->start_controls_section( 'title_and_content_text_setting',
		array(
	...
	$this->add_control( 'title_text',
		array(
			...
			'default'     => __('Image Card Title', 'wpmozo-addons-for-elementor-lite'),
			'dynamic'     => array( 'active' => true ),
			'placeholder' => esc_html__( 'Enter Title Here', 'wpmozo-addons-for-elementor-lite' )
		)
	);
	$this->add_control( 'content_text',
		array(
			...
			'label_block' => true,
			'placeholder' => esc_html__( 'Enter Content Here', 'wpmozo-addons-for-elementor-lite' ),
			'show_label'  => true,
			'dynamic'     => array( 'active' => true ),
...
//Image controls 
$this->start_controls_section( 'image_setting',
		array(
...
$this->start_controls_section( 'layout_selection_section',
		array(
			'label' => esc_html__( 'Select Layout', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control( 'select_layout',
		array(
			...
			'options'     => array(
				'lily'   => esc_html__( 'Effect: Lily', 'wpmozo-addons-for-elementor-lite' ),
				'sadie'  => esc_html__( 'Effect: Sadie', 'wpmozo-addons-for-elementor-lite' ),
				'roxy'   => esc_html__( 'Effect: Roxy', 'wpmozo-addons-for-elementor-lite' ),
				'bubba'  => esc_html__( 'Effect: Bubba', 'wpmozo-addons-for-elementor-lite' ),
				'romeo'  => esc_html__( 'Effect: Romeo', 'wpmozo-addons-for-elementor-lite' ),
				'layla'  => esc_html__( 'Effect: Layla', 'wpmozo-addons-for-elementor-lite' ),
				'oscar'  => esc_html__( 'Effect: Oscar', 'wpmozo-addons-for-elementor-lite' ),
				'marley' => esc_html__( 'Effect: Marley', 'wpmozo-addons-for-elementor-lite' ),
				'ruby'   => esc_html__( 'Effect: Ruby', 'wpmozo-addons-for-elementor-lite' ),
				'milo'   => esc_html__( 'Effect: Milo', 'wpmozo-addons-for-elementor-lite' ),
			),
			'default' => 'lily',
		)
	);
...
$this->start_controls_section( 'layout_styling_section',
		array(
			'label' => esc_html__( 'Layout Settings', 'wpmozo-addons-for-elementor-lite' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		)
	);
	...
	$this->add_responsive_control( 'border_size_slider',
		array(
			'label' => esc_html__( 'Border Size', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_responsive_control( 'image_opacity_slider',
		array(
			'label' => esc_html__( 'Image Opacity', 'wpmozo-addons-for-elementor-lite' ),
			'type'  => Controls_Manager::SLIDER,
			'range' => 
			array(
				'%' => 
...
$this->start_controls_section( 'image_overlay_color_section',
		array(
	...
	$this->add_control( 'image_overlay_color',
		array(
			...
			'default'     => '',
			'selectors'   => array(
				'{{WRAPPER}} figure.effect-lily, {{WRAPPER}} figure.effect-sadie figcaption::before, {{WRAPPER}} figure.effect-roxy, {{WRAPPER}} figure.effect-bubba, {{WRAPPER}} figure.effect-layla, {{WRAPPER}} figure.effect-oscar, {{WRAPPER}} figure.effect-ruby, {{WRAPPER}} figure.effect-milo' => 'background: {{VALUE}};',
			),
		)
	);
$this->end_controls_section();
...
$this->start_controls_section( 'content_text_styling_section',
		array(
			'label' => esc_html__( 'Content', 'wpmozo-addons-for-elementor-lite' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		)
	...
	$this->add_control( 'content_text_alignment',
		array(
...
$this->start_controls_section( 'interactive_image_alignment',
		array(
			'label'      => esc_html__( 'Alignment', 'wpmozo-addons-for-elementor-lite' ),
			'tab'        => Controls_Manager::TAB_ADVANCED,
			'condition' => array( 'image_size_size!' => 'full', 'image_size_size!' => 'custom'  )
		)
	);
