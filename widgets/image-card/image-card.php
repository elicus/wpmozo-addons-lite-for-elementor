...
if ( ! class_exists( 'WPMOZO_AE_Image_Card' ) ) {
	class WPMOZO_AE_Image_Card extends Widget_Base {
		...
		public function get_style_depends() {
			wp_register_style( 'wpmozo-ale-imagecard-style', plugins_url( 'assets/css/style.min.css', __FILE__ ), null, WPMOZO_ADDONS_LITE_FOR_ELEMENTOR_VERSION );

			return array( 'wpmozo-ale-imagecard-style' );
		}
		...
		protected function render() {
			...
			$button_url             = isset( $settings['button_url'] ) ? esc_url( $settings['button_url']['url'] ) : '#';
			...
			if ( ! empty( $settings['button_url']['url'] ) ) {
				$sanitized_url                 = esc_url( $settings['button_url']['url'] );
