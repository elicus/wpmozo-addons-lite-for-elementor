...
$this->start_controls_section(
		'text_content',
		array(
			'label' => esc_html__( 'Heading Content', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control(
		'pre_heading',
		array(
			'label'       => esc_html__( 'Pre Heading', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
			'type'        => Controls_Manager::TEXT,
			'default'     => __('Pre', 'wpmozo-addons-for-elementor-lite' ),
			'dynamic'     => array( 'active' => true ),
			'placeholder' => esc_html__( 'Pre Heading', 'wpmozo-addons-for-elementor-lite' ),
		)
	);
	$this->add_control(
		'heading',
		array(
			'label'       => esc_html__( 'Heading', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
			'type'        => Controls_Manager::TEXT,
			'default'     => __('Main', 'wpmozo-addons-for-elementor-lite' ),
			'dynamic'     => array( 'active' => true ),
			'placeholder' => esc_html__( 'Main Heading', 'wpmozo-addons-for-elementor-lite' ),
		)
	);
	$this->add_control(
		'post_heading',
		array(
			'label'       => esc_html__( 'Post Heading', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
			'type'        => Controls_Manager::TEXT,
			'default'     => __('Post', 'wpmozo-addons-for-elementor-lite' ),
			'dynamic'     => array( 'active' => true ),
			'placeholder' => esc_html__( 'Post Heading', 'wpmozo-addons-for-elementor-lite' ),
		)
	);
	$this->add_control(
		'display_inline',
		array(
			'label'        => esc_html__( 'Display In Stack', 'wpmozo-addons-for-elementor-lite' ),
...
// Text content controls end here
...
$this->start_controls_section(
		...
		array(
			'label' => esc_html__( 'Global Text Settings', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control(
		...
		array(
			'label'       => esc_html__( 'Text Alignment', 'wpmozo-addons-for-elementor-lite' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => true,
			'separator'   => 'before',
			'options'     =>
...
$this->end_controls_section();
// Global text settings tab ends here

// Pre text settings tab starts here
$this->start_controls_section(
		'pre_text_settings',
		array(
			'label' => esc_html__( 'Pre Text Settings', 'wpmozo-addons-for-elementor-lite' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		)
	);
	$this->add_group_control(
		...
		array(
			'label'       => esc_html__( 'Pre Typography', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
	...
	$this->add_control(
		...
		array(
			'label'     => esc_html__( 'Styling', 'wpmozo-addons-for-elementor-lite' ),
	...
	$this->add_control(
		...
		array(
			'label'     => esc_html__( 'Spacing', 'wpmozo-addons-for-elementor-lite' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		)
	);
	...
	$this->start_controls_tabs('pre_text_padding_margin_control_tabs');
		...
		$this->start_controls_tab(
				...
				array(
					'label' => __( 'Padding', 'wpmozo-addons-for-elementor-lite' ),
				)
			);
			$this->add_responsive_control(
				'pre_text_padding',
		...
		$this->start_controls_tab(
				'pre_text_margin_tab',
				array(
					'label' => __( 'Margin', 'wpmozo-addons-for-elementor-lite' ),
				)
			);
			$this->add_responsive_control(
				'pre_text_margin',
	...
	$this->end_controls_tabs();
$this->end_controls_section();
// Pre text settings tab ends here

// Main text settings tab starts here
$this->start_controls_section(
		'main_text_settings',
		array(
			'label' => esc_html__( 'Main Text Settings', 'wpmozo-addons-for-elementor-lite' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		)
	);
	$this->add_group_control(
		Group_Control_Typography::get_type(),
		array(
			'label'       => esc_html__( 'Main Typography', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
	...
	$this->end_controls_tabs();
$this->end_controls_section();
// Main text settings tab ends here
...
$this->start_controls_section(
		'post_text_settings',
		array(
			'label' => esc_html__( 'Post Text Settings', 'wpmozo-addons-for-elementor-lite' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		)
	);
	$this->add_group_control(
		Group_Control_Typography::get_type(),
		array(
			'label'       => esc_html__( 'Post Typography', 'wpmozo-addons-for-elementor-lite' ),
			'label_block' => true,
...
// Post text setting tab ends here